""" # Example usage:
python click_region.py -i sample_match.png
"""
import cv2
import argparse
import os
...
ap.add_argument("-o", "--output", default="clock_coords", help="Path to output file")
# ap.add_argument("-m", "--mode", required=True, help="mode: point or bbox")
args = vars(ap.parse_args())


# before this: cycle through different types
img = cv2.imread(args["image"])
output_path = args["output"]
print "foo", img.shape, output_path
