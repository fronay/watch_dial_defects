...
def autocrop(image, scale=0.05, show_plot=True, save_name=None):
    ...
    if crop_bbox is not None:
        ...
        """
        wugl_box_side = int(0.5*min((maxr-minr), (maxc-minc)))
        r1 = y_c - wugl_box_side
        r2 = y_c + wugl_box_side
        c1 = x_c - wugl_box_side
        c2 = x_c + wugl_box_side
        cropped_region = image[c1:c2, r1:r2]
        """
...
if __name__ == "__main__":
    print "executing autocropper as main"
