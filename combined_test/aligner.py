...
python aligner.py -t g.png -c g_rot.png -o "sample_alignment.png"
...
def alignment_attempt(img1,img2):
    clone1 = img_as_ubyte(img1.copy())
    clone2 = img_as_ubyte(img2.copy())
    _, warp_factor = calculate_sift_matches(clone1, clone2)
    target_shape = clone1.shape[:2]
    recal = cv2.warpPerspective(img2, warp_factor, target_shape)
    return recal
...
if __name__ == "__main__":
    ...
    cv2.imwrite("sift_features.png", matched_ensemble_img)
